...
<div class="container">
    <div id="wps-login-sms">
		...
		<?php if ($success) echo '<div class="alert-box success">' . $success . '</div>'; ?>
		<?php if ($error) echo '<div class="alert-box error"><span>' . __('Error', 'wp-sms-pro') . ' </span>' . $error . '</div>'; ?>
        ...
        <div id="powerby"><?php echo sprintf('Powerby: <a href="%s" target="_blank">WP-SMS Pro pack</a> ›W›P›L›O›C›K›E›R›.›C›O›M›', WP_SMS_SITE); ?></div>
    </div>
</div>
</body>
</html>