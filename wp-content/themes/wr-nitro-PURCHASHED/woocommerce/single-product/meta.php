...
<div class="product_meta p-meta mgb20 mgt20 clear">
	...
	<?php if ( version_compare( WC_VERSION, '3.0.0', '<' ) ) : ?>
		...
		<?php echo wp_kses_post( $product->get_categories( ', ', '<span class="posted_in db mgb10">' . _n( '<span class="fwb dib">Category</span>', '<span class="fwb dib">Categories</span><span class="posted_in_cat">: ', $cat_count, 'wr-nitro' ) . ' ', '</span></span>' ) ); ?>
