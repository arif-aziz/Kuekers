...
?>
	<form class="cart" method="post" enctype='multipart/form-data'>
					...
					foreach ( $grouped_products as $product_id ) :
						...
						<tr>
							...
							<td class="group-title">
								<label class="db" for="product-<?php echo $product_id; ?>">
		...
		<?php if ( $quantites_required ) : ?>
			...
			<button type="submit" class="single_add_to_cart_button button alt <?php echo ( $add_to_cart_ajax ? 'wr_single_add_to_cart_ajax' : NULL ); ?>"><i class="nitro-icon-<?php echo esc_attr( $icons ); ?>-cart mgr10 mgt10"></i><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button>
