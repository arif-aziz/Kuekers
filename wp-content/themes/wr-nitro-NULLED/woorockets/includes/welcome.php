...
class WR_Nitro_Welcome {
	...
	public static function html() {
		...
		$support    = 'http://woorockets.ticksy.com';
		...
		<div id="support" class="tab-pane" role="tabpanel">
			<div class="three-col">
				...
				<div class="col">
					...
					<a target="_blank" rel="noopener noreferrer" href="http://woorockets.ticksy.com" class="button button-primary"><?php esc_html_e( 'Request Support', 'wr-nitro' ); ?></a>
				</div>
			</div>
		</div>
		<?php
