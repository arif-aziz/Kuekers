...
<div class="<?php echo esc_attr( WR_Nitro_Render::$content_class ) . ( is_customize_preview() ? ' customizable customize-section-blog_list' : '' ); ?>" <?php WR_Nitro_Helper::schema_metadata( array( 'context' => 'content' ) ); ?>>
