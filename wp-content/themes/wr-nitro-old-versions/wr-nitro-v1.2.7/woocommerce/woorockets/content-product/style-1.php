		...
		<?php wc_get_template( 'woorockets/content-product/product-image.php' ); ?>
			...
			<div class="product__action pa icon_color">
				<?php
					...
					// Quick buy button
					if ( $wr_nitro_options['wc_buynow_btn'] && $product->product_type == 'simple' && ! $wr_catalog_mode && $product->is_in_stock() && ! WR_Nitro_Helper::check_gravityforms( $post->ID ) && ! WR_Nitro_Helper::yith_wc_product_add_ons( $post->ID ) && ! WR_Nitro_Helper::wc_measurement_price_calculator( $post->ID ) && $booster_pop != 'yes' ) {
