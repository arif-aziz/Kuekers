	...
	<div class="product__wrap">
		...
		<div class="product__content">
			<div class="product__title tc mgb10">
				<h5><a class="hover-primary" href="<?php esc_url( the_permalink() ); ?>" title="<?php esc_attr( the_title() ); ?>"><?php the_title(); ?></a></h5>
			</div><!-- .product__title -->
			...
			<?php if ( ! $wr_catalog_mode ) : ?>
				<div class="product__action pa fc jcsa mgt20 nitro-line">
					<?php
						...
						// Quick buy button
						if ( $wr_nitro_options['wc_buynow_btn'] && $product->product_type == 'simple' && ! WR_Nitro_Helper::check_gravityforms( $post->ID ) && ! WR_Nitro_Helper::yith_wc_product_add_ons( $post->ID ) && ! WR_Nitro_Helper::wc_measurement_price_calculator( $post->ID ) ) {
