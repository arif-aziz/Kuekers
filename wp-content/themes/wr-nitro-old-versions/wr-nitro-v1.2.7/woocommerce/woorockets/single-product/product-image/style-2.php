		...
		<div id="p-large" class="wr-nitro-carousel exclude-carousel images <?php if ( $thumb_position == 'left' ) echo 'fr'; ?> ">
			<?php
				...
				if ( has_post_thumbnail() ) {
					...
					echo apply_filters( 'woocommerce_single_product_image_html', sprintf( '<a ' . $lightbox . ' href="%s" itemprop="image" data-type="image-gallery-highlights" title="%s" data-lightbox="nivo" ' . $gallery . '>%s</a>', $image_link, $image_caption, $image ), $post->ID );
