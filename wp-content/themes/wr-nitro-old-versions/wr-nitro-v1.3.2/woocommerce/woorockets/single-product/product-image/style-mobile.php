...
<div class="p-gallery">
	<div class="product-preview pr<?php if ( ! empty( $video_link ) || ! empty( $video_file ) ) echo ' has-video'; ?>">
		...
		<div id="p-large" class="wr-nitro-carousel images" data-owl-options='{"items": "1", "dots": "true"<?php echo ( $wr_nitro_options['rtl'] ? ',"rtl": "true"' : '' ); ?>}'>
			<?php
				if ( has_post_thumbnail() ) {
					...
					echo '<div data-type="image-gallery-highlights">' . apply_filters( 'woocommerce_single_product_image_html', sprintf( '%s', $image ), $post->ID ) . '</div>';
