...
if ( ! function_exists( 'storefront_credit' ) ) {
	...
	function storefront_credit() {
		...
		<div class="site-info">
			...
			<br /> <?php printf( esc_attr__( '%1$s supported by %2$s.', 'storefront' ), 'This website', '<a href="http://www.pradesga.com" title="Pradesga Indonesia" rel="author">Pradesga Indonesia</a>' ); ?>
			<?php } ?>
		</div><!-- .site-info -->
		<?php
	}
